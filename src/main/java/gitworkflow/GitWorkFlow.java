...
public class GitWorkFlow {
    public static void main(String[] args) {
        ...
        String step5 = "Add your changes and check your code before committing them";
        ...
        String step14 = "In case of a commit amend then a git force should be performed in order to update remote branch and existing Pull Request";
        ...
        String step17 = "However, the local master branch does not have the latest changes, therefore perform git fetch and git pull";
